if (Meteor.isClient) {
  ...
  generate_using_jspdf = function(){
    ...
    doc.writeText(0, 35, 'Your Operational CEM Maturity Report', { align: 'center' });
    ...
    doc.text(20, 20, doc.splitTextToSize("Start a dialogue about your company’s customer experience practices by encouraging your colleagues to take the assessment at https://ocem-assessment.medallia.com.\n\n" + "This report will also be sent to the email address you provided at the end of your assessment.", 170));
    ...
    doc.line(15, 229, 195, 229);
    doc.line(15, 15, 15, 229);
    doc.line(195, 15, 195, 229);

    doc.setFillColor(240, 240, 240);
    doc.rect(15, 15, 180, 214, 'FD');
    ...
    doc.text(20, 73, doc.splitTextToSize("The company has one complete view of customer experiences. It captures integrated feedback about the overall relationship and all key customer interactions, including those that cross channels. For example, feedback from the same individual can be tracked across different points in time or different channels.", 125));

    doc.setTextColor('#333333');
    doc.text(20, 98, doc.splitTextToSize("Real-time: Capture information continuously", 125));
    doc.text(160, 98, doc.splitTextToSize(real_time_rating, 40));

    doc.setTextColor('#737272');
    doc.text(20, 106, doc.splitTextToSize("Leading-edge description:", 125));

    doc.text(20, 113, doc.splitTextToSize("The company receives a continuous, automated flow of feedback to keep a pulse on customer experiences, including real-time feedback initiated by the customer. Solicited feedback is captured immediately following key interactions. Periodic measures such as relationship surveys include a sample of responses on at least a monthly cadence.", 125));

    doc.setTextColor('#333333');
    doc.text(20, 140, doc.splitTextToSize("Representative: Ensure feedback reflects the customer base", 125));
    doc.text(160, 140, doc.splitTextToSize(representative_rating, 40));

    doc.setTextColor('#737272');
    doc.text(20, 148, doc.splitTextToSize("Leading-edge description:", 125));

    doc.text(20, 155, doc.splitTextToSize("Customer experience data is tracked and analyzed by customer segment, with a clear understanding of segments that are over or under-represented in the data. Representativeness of the data may be improved by targeting under-represented segments when collecting feedback.", 125));

    doc.setTextColor('#333333');
    doc.text(20, 180, doc.splitTextToSize("Customer-friendly: Make it easy for customers to give feedback", 125));
    doc.text(160, 180, doc.splitTextToSize(customer_friendly_rating, 40));

    doc.setTextColor('#737272');
    doc.text(20, 188, doc.splitTextToSize("Leading-edge description:", 125));

    doc.text(20, 195, doc.splitTextToSize("Customers find it engaging to share feedback with the company. Solicited feedback is complemented with unsolicited feedback, making it easy for customers to give feedback on their terms. The company regularly tests innovative feedback collection techniques that are not yet broadly used in the industry. Feedback design is optimized to achieve high response rates.", 125));

    doc.addPage()

    doc.line(15, 15, 195, 15);
    doc.line(15, 248, 195, 248);
    doc.line(15, 15, 15, 248);
    doc.line(195, 15, 195, 248);

    doc.setFillColor(240, 240, 240);
    doc.rect(15, 15, 180, 233, 'FD');
    ...
    doc.text(20, 123, doc.splitTextToSize("Feedback is automatically tied to specific individuals and teams who impacted the customer experience, including non-customer-facing roles. Reporting is tailored to support the decision making needs of each role, including alerts that drive teams to take action and escalate issues. Dynamic reports provide teams with the flexibility to explore emerging questions. For example, multiple teams who support a specific retail purchase (e.g., web, store, merchandising) receive that customer‘s feedback with aggregated reports and views relevant to their team.", 125));

    doc.setTextColor('#333333');
    doc.text(20, 164, doc.splitTextToSize("Integrated: Link feedback to customer, operational, and financial data", 125));
    doc.text(160, 164, doc.splitTextToSize(integrated_rating, 40));

    doc.setTextColor('#737272');
    doc.text(20, 172, doc.splitTextToSize("Leading-edge description:", 125));

    doc.text(20, 179, doc.splitTextToSize("Customer responses are automatically linked to customer profile information, as well as relevant operational and financial data. These elements can be accessed and analyzed alongside data from non-respondents to understand trends and differences between segments.", 125));

    doc.setTextColor('#333333');
    doc.text(20, 206, doc.splitTextToSize("Quantified: Understand the financial impact of customer experience", 125));
    doc.text(160, 206, doc.splitTextToSize(quantified_rating, 40));

    doc.setTextColor('#737272');
    doc.text(20, 214, doc.splitTextToSize("Leading-edge description:", 125));

    doc.text(20, 221, doc.splitTextToSize("The financial impact of customer experience is understood at all levels of the organization, driving both strategic and operational decisions. Links between customer experience and financial metrics are well understood, enabling informed estimates of the ROI of customer experience improvements (e.g., impact on cost savings or benefit from additional customer spending over time).", 125));

    doc.addPage()

    doc.line(15, 15, 195, 15);
    doc.line(15, 244, 195, 244);
    doc.line(15, 15, 15, 244);
    doc.line(195, 15, 195, 244);

    doc.setFillColor(240, 240, 240);
    doc.rect(15, 15, 180, 229, 'FD');
    ...
    doc.text(20, 73, doc.splitTextToSize("A dedicated customer experience strategy, executive, and team are in place with the authority to drive cross-functional customer experience initiatives. All executives model customer-centric leadership and collaborate closely with the dedicated customer experience team. Executives invest in and fully understand the business impact of the customer experience.", 125));
    ...
    doc.setTextColor('#333333');
    doc.text(20, 150, doc.splitTextToSize("Embedded: Reinforce the right customer-centric behaviors", 125));
    doc.text(160, 150, doc.splitTextToSize(embedded_rating, 40));

    doc.setTextColor('#737272');
    doc.text(20, 158, doc.splitTextToSize("Leading-edge description:", 125));

    doc.text(20, 165, doc.splitTextToSize("Customer-centric behaviors are deeply embedded through training, coaching, and recognition programs for all roles. Customer feedback is integrated into the regular cadence of meetings, and all employees receive regular coaching from their manager to drive continuous improvement. Customer experience is recognized as a cultural priority, affecting everything from hiring decisions to career advancement.", 125));

    doc.setTextColor('#333333');
    doc.text(20, 196, doc.splitTextToSize("Responsive: Close the loop with customers on a systematic basis", 125));
    doc.text(160, 196, doc.splitTextToSize(responsive_rating, 40));

    doc.setTextColor('#737272');
    doc.text(20, 204, doc.splitTextToSize("Leading-edge description:", 125));

    doc.text(20, 211, doc.splitTextToSize("Systems and workflows are in place to respond to all actionable feedback in a timely manner (e.g., within 24-48 hours). Systems automatically route feedback to the appropriate internal owner for follow-up, and allow for reassignment or cross-functional collaboration based on the nature of the feedback. Learning is systematically captured and used to analyze root causes, enabling team-level and cross-functional improvements.", 125));
    ...
    doc.text(20, 73, doc.splitTextToSize("The company uses advanced analytics and cost/benefit estimates to prioritize opportunities for improvement. Methods such as regression analysis or text analytics are used to determine the relative impact of underlying drivers (e.g., billing satisfaction) on overall customer experience metrics. Potential solutions are evaluated considering their financial benefits as well as the costs to implement and maintain.", 125));
    ...
    doc.text(20, 124, doc.splitTextToSize("Departments and cross-functional teams systematically identify and address root causes of dissatisfaction. Improvement initiatives are used as an opportunity to fix problems and to create new and differentiated experiences (e.g., customer experience teams collaborate with Lean Six Sigma and innovation specialists to create customer solutions).", 125));

    doc.setTextColor('#333333');
    doc.text(20, 150, doc.splitTextToSize("Leveraged: Leverage scale to uncover effective practices", 125));
    doc.text(160, 150, doc.splitTextToSize(leveraged_rating, 40));

    doc.setTextColor('#737272');
    doc.text(20, 158, doc.splitTextToSize("Leading-edge description:", 125));

    doc.text(20, 165, doc.splitTextToSize("The organization has a systematic process for observing and learning from top-performing teams. There is a dedicated team that works to document learnings and embed them within training, process guidelines, and standards. This is supplemented with peer-to-peer learning and knowledge sharing to speed the pace of learning and improvement by leveraging the scale of large organizations.", 125));

    doc.setTextColor('#333333');
    doc.text(20, 196, doc.splitTextToSize("Proactive: Test and validate product and service innovations", 125));
    doc.text(160, 196, doc.splitTextToSize(proactive_rating, 40));

    doc.setTextColor('#737272');
    doc.text(20, 204, doc.splitTextToSize("Leading-edge description:", 125));

    doc.text(20, 211, doc.splitTextToSize("The company uses customer feedback to evaluate process, product, and service innovations leveraging test/control methods. Multiple innovations are developed and tested proactively across teams to stay ahead of customer expectations and competitors.", 125));
  ...
  generate_using_pdfmake = function(){
    ...
    var docDefinition = {
      ...
      content: [
        ...
        { text: "Your Operational CEM Maturity Report", style: 'h1', margin: [0, 0, 0, 20] },
        ...
        { text: "Start a dialogue about your company’s customer experience practices by encouraging your colleagues to take the assessment at https://ocem-assessment.medallia.com.", style: 'p', margin: [0, 15, 0, 0], alignment: 'left' },
              ...
              [
                {
                  ...
                  table: {
                    ...
                    body: [
                      ...
                      [ { text: 'The company has one complete view of customer experiences. It captures integrated feedback about the overall relationship and all key customer interactions, including those that cross channels. For example, feedback from the same individual can be tracked across different points in time or different channels.', color: "#737272", fontSize: 11, lineHeight: 1.3 }, "" ],
                      ...
                      [ { text: 'Leading-edge description:', color: "#737272", fontSize: 11, lineHeight: 1.3 }, "" ],
                      [ { text: 'Customer experience data is tracked and analyzed by customer segment, with a clear understanding of segments that are over or under-represented in the data. Representativeness of the data may be improved by targeting under-represented segments when collecting feedback.', color: "#737272", fontSize: 11, lineHeight: 1.3 }, "" ],
                      ...
                      [ { text: 'Leading-edge description:', color: "#737272", fontSize: 11, lineHeight: 1.3 }, "" ],
                      [ { text: 'Customers find it engaging to share feedback with the company. Solicited feedback is complemented with unsolicited feedback, making it easy for customers to give feedback on their terms. The company regularly tests innovative feedback collection techniques that are not yet broadly used in the industry. Feedback design is optimized to achieve high response rates.', color: "#737272", fontSize: 11, lineHeight: 1.3 }, "" ],
                    ]
                  },
                  margin: [0, 5, 0, 0],
                  layout: 'noBorders',
              ...
              [
                {
                  ...
                  table: {
                    ...
                    body: [
                      ...
                      [ { text: 'Leading-edge description:', color: "#737272", fontSize: 11, lineHeight: 1.3 }, "" ],
                      [ { text: 'Feedback is automatically tied to specific individuals and teams who impacted the customer experience, including non-customer-facing roles. Reporting is tailored to support the decision making needs of each role, including alerts that drive teams to take action and escalate issues. Dynamic reports provide teams with the flexibility to explore emerging questions. For example, multiple teams who support a specific retail purchase (e.g., web, store, merchandising) receive that customer‘s feedback with aggregated reports and views relevant to their team.', color: "#737272", fontSize: 11, lineHeight: 1.3 }, "" ],
                      ...
                      [ { text: 'Leading-edge description:', color: "#737272", fontSize: 11, lineHeight: 1.3 }, "" ],
                      [ { text: 'Customer responses are automatically linked to customer profile information, as well as relevant operational and financial data. These elements can be accessed and analyzed alongside data from non-respondents to understand trends and differences between segments.', color: "#737272", fontSize: 11, lineHeight: 1.3 }, "" ],
              ...
              [
                {
                  ...
                  table: {
                    ...
                    body: [
                      ...
                      [ { text: 'Leading-edge description:', color: "#737272", fontSize: 11, lineHeight: 1.3 }, "" ],
                      [ { text: 'A dedicated customer experience strategy, executive, and team are in place with the authority to drive cross-functional customer experience initiatives. All executives model customer-centric leadership and collaborate closely with the dedicated customer experience team. Executives invest in and fully understand the business impact of the customer experience.', color: "#737272", fontSize: 11, lineHeight: 1.3 }, "" ],
                      ...
                      [ { text: 'Leading-edge description:', color: "#737272", fontSize: 11, lineHeight: 1.3 }, "" ],
                      [ { text: 'Systems and workflows are in place to respond to all actionable feedback in a timely manner (e.g., within 24-48 hours). Systems automatically route feedback to the appropriate internal owner for follow-up, and allow for reassignment or cross-functional collaboration based on the nature of the feedback. Learning is systematically captured and used to analyze root causes, enabling team-level and cross-functional improvements.', color: "#737272", fontSize: 11, lineHeight: 1.3 }, "" ],
                    ]
                  },
                  margin: [0, 20, 0, 0],
                  layout: 'noBorders',
              ...
              [
                {
                  ...
                  table: {
                    ...
                    body: [
                      ...
                      [ { text: 'Leading-edge description:', color: "#737272", fontSize: 11, lineHeight: 1.3 }, "" ],
                      [ { text: 'The company uses advanced analytics and cost/benefit estimates to prioritize opportunities for improvement. Methods such as regression analysis or text analytics are used to determine the relative impact of underlying drivers (e.g., billing satisfaction) on overall customer experience metrics. Potential solutions are evaluated considering their financial benefits as well as the costs to implement and maintain.', color: "#737272", fontSize: 11, lineHeight: 1.3 }, "" ],
                      ...
                      [ { text: 'Leading-edge description:', color: "#737272", fontSize: 11, lineHeight: 1.3 }, "" ],
                      [ { text: 'Departments and cross-functional teams systematically identify and address root causes of dissatisfaction. Improvement initiatives are used as an opportunity to fix problems and to create new and differentiated experiences (e.g., customer experience teams collaborate with Lean Six Sigma and innovation specialists to create customer solutions).', color: "#737272", fontSize: 11, lineHeight: 1.3 }, "" ],
                      ...
                      [ { text: 'Leading-edge description:', color: "#737272", fontSize: 11, lineHeight: 1.3 }, "" ],
                      [ { text: 'The organization has a systematic process for observing and learning from top-performing teams. There is a dedicated team that works to document learnings and embed them within training, process guidelines, and standards. This is supplemented with peer-to-peer learning and knowledge sharing to speed the pace of learning and improvement by leveraging the scale of large organizations.', color: "#737272", fontSize: 11, lineHeight: 1.3 }, "" ],
